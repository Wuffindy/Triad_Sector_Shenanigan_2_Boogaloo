...
namespace Content.Server.NodeContainer.Nodes
{
    ...
    public partial class PipeNode : Node, IGasMixtureHolder, IRotatableNode
    {
            ...
            IEntityManager entMan)
        {
            ...
            var gridEnt = new Entity<MapGridComponent>(xform.GridUid!.Value, grid);
            var pos = mapSystem.TileIndicesFor(gridEnt, xform.Coordinates);
        ...
        private IEnumerable<PipeNode> LinkableNodesInDirection(Vector2i pos, PipeDirection pipeDir, Entity<MapGridComponent> grid,
            EntityQuery<NodeContainerComponent> nodeQuery, SharedMapSystem mapSystem)
        {
