...
public sealed partial class SupermatterGasBarContainer : BoxContainer
{
    ...
    public SupermatterGasBarContainer(Gas gas)
    {
        ...
        // Set labels
        // Triad: this fork's Gas enum carries gases (BZ..Pluoxium) that GasData deliberately omits;
    ...
    {
        // Triad: guard against an empty mixture (inactive crystal / SpaceGas fallback) so we don't render NaN%
