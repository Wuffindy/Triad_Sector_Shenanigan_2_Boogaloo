...
nf-tips-dataset-18 = Object stuck in your hand? Press Q to gently drop it!
...
nf-tips-dataset-20 = Every crewmember comes with an emergency medipen in their survival box containing epinephrine and tranexamic acid, along with a crowbar, MRE, and a large emergency oxygen tank - Make sure to use them!
...
nf-tips-dataset-31 = Plasma glass and Uranium glass windows can be used to reinforce an area and prevent radiation... Somehow."
...
nf-tips-dataset-40 = We were all new once, be patient and guide new players in the right direction.
...
nf-tips-dataset-53 = You can climb onto many machines or other objects by dragging yourself onto one.
...
nf-tips-dataset-64 = Monolith Station is open source! If there's a change you want to make, or a simple item you want to add, then try contributing to the game. It's not as hard as you'd think it is.
...
nf-tips-dataset-82 = Felinids and other small species can sit in bags!
...
nf-tips-dataset-84 = Bored? Invite friends! You can call on Discord while playing. Remember to stay out of calls during PvP situations!
...
nf-tips-dataset-86 = Big Brother is watching.
...
nf-tips-dataset-106 = Sometimes, the best way to make the game easier is to get good.
nf-tips-dataset-107 = Some large ships can act as motherships. They tend to have shipyard consoles, which allow you to purchase and sell other smaller ships!
nf-tips-dataset-108 = Remember to read the guidebook for information on many roles! Many a time a guidebook can contain information on how to quell threats or find a unique effect.
nf-tips-dataset-109 = Join the Discord! There you can vote on polls and have a say in the community.
nf-tips-dataset-110 = There's a special app installed in your PDA, which allows you to see posted bounties. If you can fulfill one of them, you can ask the poster for a reward!
nf-tips-dataset-111 = Remember, Venmar Station has a 256m wide safe-zone. It's forbidden to steal from ships or ID's within that limit! Read the rules for more information.
...
nf-tips-dataset-114 = Expeditions can yield rare and useful items, and can turn a prospecting mercenary down on their luck to an opponent capable of rivaling faction members!
...
nf-tips-dataset-116 = Every shuttle console has an internal traffic intercom. Make sure to use it to contact the STC before docking with Colossus or Camelot!
nf-tips-dataset-117 = If you get stranded in space, make sure to notify others using the radio! Getting depressed and falling into a coma is never the best solution.
...
nf-tips-dataset-121 = As an PD imperial, you can get bounties to earn data chits! Think of which ship would be most likely to have the items you need.
nf-tips-dataset-122 = As an PD imperial, remember the laws of escalation! Look after Clarrrpy, raid with dignity - Other characters are people too!
